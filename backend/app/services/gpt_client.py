...
Don't had any features. Keep the original drawning/composition. Keep all the lines/patterns/features, without transformation. Including inner detail lines.
Remove little parasite lines. Complete holes if the lines are nearly touching each other.
